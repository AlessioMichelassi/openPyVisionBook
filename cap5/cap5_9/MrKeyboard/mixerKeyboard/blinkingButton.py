...
class BlinkingButton(QPushButton):
    ...
    def __init__(self, text, blinkColor="rgb(255,128,10)", blinkInterval=150, blinkingTimeOut=100, parent=None):
    ...
    def _returnStyleSheet(self):
        ...
        QPushButton:pressed  {{
            ...
            border: 1px solid {self.borderPressed};
            border-radius: 2px;
            color: {self.colorPressed};
        }}
        QPushButton:!pressed {{
            background-color: {self.normalColor.name()};
            border: 1px solid {self.borderUnPressed};
            border-radius: 2px;
