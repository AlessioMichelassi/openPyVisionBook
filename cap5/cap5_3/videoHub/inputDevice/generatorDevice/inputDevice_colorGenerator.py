...
from cap5.cap5_3.videoHub.inputDevice.generatorDevice.generatorWidget.colorGeneratorsWidget import ColorGeneratorWidget
from cap5.mainDir.inputs.generator.generator_Color import ColorGenerator
