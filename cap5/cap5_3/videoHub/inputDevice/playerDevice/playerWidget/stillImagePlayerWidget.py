...
from cap5.cap5_3.videoHub.inputDevice.playerDevice.playerWidget.playerDialog.imageConfigDialog import \
    ImagePlayerConfigDialog
...
if __name__ == "__main__":
    import sys
    from cap5.mainDir.inputs.player.player_StillImage import StillImagePlayer
