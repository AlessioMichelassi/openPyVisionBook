...
from cap5.mainDir.inputDevice.generatorDevice.generatorWidget.smpteGeneratorWidget import SmpteGeneratorWidget
from cap5.mainDir.inputDevice.generatorDevice.inputObject.generator_SMPTE import SMPTEBarsGenerator
