...
from cap5.mainDir.inputDevice.captureDevice.inputObject.deviceFinder.deviceUpdater import DeviceUpdater
...
class DeviceUpdaterWidget(QComboBox):
    ...
    def __init__(self, parent=None):
        super(DeviceUpdaterWidget, self).__init__(parent)
    ...
    def getCurrentDeviceSelected(self):
        return {self.currentIndex - 1: self.deviceDictionary.get(self.currentIndex - 1, {}).get('name',
                                                                                                'None')}  # Adjust index
