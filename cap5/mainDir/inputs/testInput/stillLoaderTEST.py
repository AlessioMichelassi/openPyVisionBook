...
from mainDir.inputs.testInput.synchObject import SynchObject
...
class VideoApp(QApplication):
    def __init__(self, argv):
        super().__init__(argv)
        testPath = r"C:\pythonCode\openPyVisionBook\openPyVisionBook\cap3\cap3_1\testClass\Grass_Valley_110_Switcher.jpg"
        self.input1 = StillImagePlayer(
            testPath)
