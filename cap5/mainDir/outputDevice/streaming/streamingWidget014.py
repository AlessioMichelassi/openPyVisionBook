...
from cap5.mainDir.outputDevice.streaming.streamerManager import StreamerManager


class StreamingWidget014(QWidget):
    ...
    def __init__(self, inputWidget, parent=None):
        super(StreamingWidget014, self).__init__(parent)
        self.inputWidget = inputWidget
        self.streamerManager = StreamerManager(self.inputWidget)
        self.initWidgets()
        self.initUI()
...
if __name__ == "__main__":
    app = QApplication([])
    window = StreamingWidget014(None)
