...
from PyQt6.QtWidgets import QApplication, QLabel, QVBoxLayout, QWidget, QProgressBar, QHBoxLayout
import cv2
import numpy as np
import sip
...
class StingerDisplay(QWidget):
    ...
    def updateFrame(self):
        ...
        if self.frames:
            ...
            self.qImg = QImage(ptr, width, height, QImage.Format.Format_BGR888)
            self.lblViewer.setPixmap(QPixmap.fromImage(self.qImg))
