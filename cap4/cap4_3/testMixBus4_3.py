...
from cap4.cap4_3.mixBus4_3 import MixBus4_3, MIX_TYPE


class testMixBus5_3(QWidget):
    def __init__(self, synchObject, parent=None):
        ...
        self.mixBus = MixBus4_3(self.input1, self.input2)
...
if __name__ == '__main__':
    ...
    test = testMixBus5_3(synchObject)
    test.show()
    sys.exit(app.exec())